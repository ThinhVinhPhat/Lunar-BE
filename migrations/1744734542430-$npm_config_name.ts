...
export class  $npmConfigName1744734542430 implements MigrationInterface {
    name = ' $npmConfigName1744734542430'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."order_status_enum_old" AS ENUM('Pending', 'Shipped', 'Delivered', 'Rejected', 'Confirmed')`);
        await queryRunner.query(`ALTER TABLE "order" ALTER COLUMN "status" DROP DEFAULT`);
