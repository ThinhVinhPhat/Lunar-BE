...
export class  $npmConfigName1743517087816 implements MigrationInterface {
    name = ' $npmConfigName1743517087816'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."order_status_enum" AS ENUM('Pending', 'Confirmed', 'Shipped', 'Delivered', 'Rejected')`);
